...
namespace Datos.Facturas
{
    ...
    public class NotaFiscalBoliviaPadraoERPOut_v1_Contexto : Contexto
    {
        ...
        public string GetXMLFromGera()
        {
            try
            {
                ...
                var export = conexion_SOAP.ExportarDados(Token, "NotaFiscalPadraoERP", "NFBolivia_1.0");
        ...
        public NotaFiscalBoliviaPadraoERPOut_v1[] GetNotaFiscalFromXML(string xml)
        {
            try
            {
                OnLog(new ObjLog() { Tipo = 4, Ticket = Ticket, CodigoDocumento = 0, Tabla = "NotaFiscalPadraoERP", Mensaje = "Deserializando NotaFiscal..." });
                XmlSerializer deserializer = new XmlSerializer(typeof(NotaFiscalBoliviaPadraoERPOut_v1[]), new XmlRootAttribute("ArrayOfNotaFiscalBoliviaPadraoERPOut_v1"));
                NotaFiscalBoliviaPadraoERPOut_v1[] notas;
                ...
                notas = (NotaFiscalBoliviaPadraoERPOut_v1[])deserializer.Deserialize(reader);
        ...
        public void GrabarNotasFiscales(NotaFiscalBoliviaPadraoERPOut_v1[] notas)
        {
        ...
        public bool CerrarTicket(NotaFiscalBoliviaPadraoERPOut_v1[] notas)
        {
